...
void PeopleManagerTest::testPersonFromResource()
{
    ...
    Nepomuk::Resource relevantPersonResource(QUrl::fromEncoded("nepomuk:/test-person"));
    Nepomuk::Resource irrelevantThingResource(QUrl::fromEncoded("nepomuk:/test-random-thing"));
    Nepomuk::Resource nonExistantResource(QUrl::fromEncoded("nepomuk:/test-non-existant-resource"));
