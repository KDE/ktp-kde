 ...
 */
class KDE_EXPORT TelepathyBridge : public QObject
{
    Q_OBJECT
...
#ifdef WITH_DBUSTUBES
    KJob* offerDBusTube(const Nepomuk::PersonContact& contact, const QLatin1String serviceName = QLatin1String("org.kde.KTelepathy.DefaultServiceName"), const QVariantMap& parameters = QVariantMap());
    KJob* offerDBusTube(const Nepomuk::Person& metacontact, const QLatin1String serviceName = QLatin1String("org.kde.KTelepathy.DefaultServiceName"), const QVariantMap& parameters = QVariantMap());
#endif // WITH_DBUSTUBES
